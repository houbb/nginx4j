...
public class NginxRequestDispatch400 extends AbstractNginxRequestDispatchFullResp {
    ...
    protected FullHttpResponse buildFullHttpResponse(FullHttpRequest request,
        ...
        return InnerRespUtil.buildCommentResp(null, HttpResponseStatus.BAD_REQUEST, request, context.getNginxConfig());
    }
