 ...
 * @author 老马啸西风
 */
public class NginxPlaceholderUserAgent extends AbstractNginxPlaceholder {

    private static final Log logger = LogFactory.getLog(NginxPlaceholderUserAgent.class);
